CREATE OR REPLACE PROCEDURE sp_Assets_Moved_Between_Div (
      rc_Assets_Moved_Between_Div      IN OUT   SYS_REFCURSOR
   ) 
   as
...
/******************************************************************************
   ...
   ---------  ----------  ---------------  ------------------------------------
   1.0        08/31/2006      -shw-    	   1. Created for "Assets Moved Between Divisions.rpt"  
   1.1		  09/06/2006	  -SHW-		   2. ADDED devicepagem1 to above 
...
*/
	  open rc_Assets_Moved_Between_Div for v_select_stmt;
   end sp_Assets_Moved_Between_Div;
/
