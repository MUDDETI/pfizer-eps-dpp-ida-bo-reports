...
/******************************************************************************
   ...
   1.6		  05/29/2008    -aj-		   1. Add the following status to exclude from the report for AC 
						     (''DONATED'', ''MARKED FOR DISPOSAL'', ''MARKED FOR DONATION'')	
   NOTES:
...
******************************************************************************/
  ...
  CISubTypes		   varchar2(32767);
   ...
   'SELECT ''In CMDB Not in AC'' as dataSource,'
	...
	|| ' and upper(ac.status) not in (''RETIRED'',''SOLD'', ''VOID'', ''ARCHIVED'', ''DISPOSED'', ''DONATED'', ''MARKED FOR DISPOSAL'', ''MARKED FOR DONATION'')'
	|| ' and l.bcreateci = 1'
	|| ' and l.slvl = 1';
