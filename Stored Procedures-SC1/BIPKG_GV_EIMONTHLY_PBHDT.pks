CREATE OR REPLACE PACKAGE SCREPORT.BIPKG_Gv_EIMONTHLY_PBHDT AS
/******************************************************************************
...
END BIPKG_Gv_EIMONTHLY_PBHDT;
/
CREATE OR REPLACE PACKAGE BODY SCREPORT.BIPKG_Gv_EIMONTHLY_PBHDT AS
/******************************************************************************
   NAME:       BIPKG_EIMONTHLY_PBHDT
   PURPOSE:
...
--        v_select_stmt := v_select_stmt || ' ,ALLTICKETS_VW.category ' ;
...
--        v_select_stmt := v_select_stmt || ' AND (' || Bipkg_Utils.bifnc_createinlist ('NVL(ALLTICKETS_VW.category, '' '')', vinteraction_type)|| ')';
