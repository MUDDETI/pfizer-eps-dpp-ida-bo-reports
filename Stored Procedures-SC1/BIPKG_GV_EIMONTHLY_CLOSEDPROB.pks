CREATE OR REPLACE PACKAGE SCREPORT.BIPKG_Gv_EIMONTHLY_CLOSEDPROB AS
/******************************************************************************
...
END BIPKG_Gv_EIMONTHLY_CLOSEDPROB;
/
CREATE OR REPLACE PACKAGE BODY SCREPORT.BIPKG_Gv_EIMONTHLY_CLOSEDPROB AS
/******************************************************************************
   NAME:       BIPKG_EIMONTHLY_CLOSEDPROB
   PURPOSE:
...
PROCEDURE BIPKG_EIMONTHLY_CLOSEDPROB(
   ...
   BEGIN          
        ...
        v_select_stmt := v_select_stmt || ' AND NOT (v_psm.PRIORITY =  ' || '''' || 'PROJECT' || '''' || ')';
