CREATE OR REPLACE PACKAGE SCREPORT.BIPKG_Gv_EIMONTHLY_MTOPPROD AS
/******************************************************************************
...
END BIPKG_Gv_EIMONTHLY_MTOPPROD;
/
CREATE OR REPLACE PACKAGE BODY SCREPORT.BIPKG_Gv_EIMONTHLY_MTOPPROD AS
/******************************************************************************
   NAME:       BIPKG_EIMONTHLY_MTOPPROD
   PURPOSE:
...
PROCEDURE BIPKG_EIMONTHLY_MTOPPROD(
   ...
   BEGIN          
        ...
        v_select_stmt := 'SELECT INCIDENTSM1.PFZ_ORIG_GROUP, INCIDENTSM1.PRODUCT_TYPE, BIPKG_UTILS.BIFNC_AdjustForTZ(INCIDENTSM1.OPEN_TIME,'|| '''' || v_db_zone || '''' || ',' || '''' || pzone || '''' || ') OPEN_TIME, INCIDENTSM1.INCIDENT_ID, ' || '''' || v_startdatedisplay || '''' || 'StartDateDisplay , ' || '''' || v_enddatedisplay || '''' || ' EndDateDisplay,INCIDENTSM1.category';
