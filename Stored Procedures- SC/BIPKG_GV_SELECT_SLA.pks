CREATE OR REPLACE PACKAGE SCREPORT.BIPKG_Gv_SELECT_SLA AS
...
END BIPKG_Gv_SELECT_SLA;
/
CREATE OR REPLACE PACKAGE BODY SCREPORT.BIPKG_Gv_Select_Sla
AS
/******************************************************************************
   NAME:       bisp_select_sla  
   PURPOSE:
...
-- Respond Overall 
        ...
        ELSE
        v_select_stmt := v_select_stmt || ' SELECT  '||''''||'RESPOND'|| ''''|| ' SLA_Type, v_psm.pfz_respond_sla_user SLA_User, NVL(v_psm.PFZ_RESPOND_2ND_TARGET, '' '') Made_Missed,NVL(v_psm.PFZ_RESPOND_2ND_TARGET_GROUP, '' '') SLA_Group,bipkg_utils.bifnc_AdjustForTZ(v_psm.PFZ_RESPOND_2ND_TARGET_TIME,'|| ''''|| vfromtz|| ''''|| ','|| ''''|| ZONE|| ''''|| ') pfz_sla_time,';
        END IF;        
        ...
        v_select_stmt := v_select_stmt || ' FROM sc.v_probsummary v_psm INNER JOIN sc.operatorm1v ON v_psm.pfz_respond_sla_user = operatorm1v.name WHERE (';
...
-- Restore Overall 
              IF vtarget_metric = 'Primary'
           Then
        v_select_stmt := v_select_stmt || ' SELECT  '||''''||'RESTORE'|| ''''|| ' SLA_Type, v_psm.pfz_restore_sla_user SLA_User, v_psm.pfz_restore_sla Made_Missed,v_psm.pfz_restore_sla_group SLA_Group,NVL(bipkg_utils.bifnc_AdjustForTZ(v_psm.pfz_restore_sla_time,'|| ''''|| vfromtz|| ''''|| ','|| ''''|| ZONE|| ''''|| '),v_psm.close_time) pfz_sla_time,';
        Else
        v_select_stmt := v_select_stmt || ' SELECT  '||''''||'RESTORE'|| ''''|| ' SLA_Type, NVL(v_psm.PFZ_RESTORE_2ND_TARGET_USER, '' '') SLA_User, NVL(v_psm.PFZ_RESTORE_2ND_TARGET, '' '') Made_Missed,NVL(v_psm.PFZ_RESTORE_2ND_TARGET_GROUP, '' '') SLA_Group,NVL(bipkg_utils.bifnc_AdjustForTZ(v_psm.PFZ_RESTORE_2ND_TARGET_TIME,'|| ''''|| vfromtz|| ''''|| ','|| ''''|| ZONE|| ''''|| '),v_psm.close_time) pfz_sla_time,';
        End If; 
        v_select_stmt := v_select_stmt || ' v_psm.action, v_psm.assignment,v_psm.assignee_name, operatorm1v.full_name,v_psm.brief_description,v_psm.closed_by, v_psm.closed_group,bipkg_utils.bifnc_AdjustForTZ(v_psm.close_time,'|| ''''|| vfromtz|| ''''|| ','|| ''''|| ZONE|| ''''|| ') close_time, v_psm.country,v_psm.flag, v_psm.last_activity,v_psm.LOCATION, v_psm.numberprgn,v_psm.open_group, bipkg_utils.bifnc_AdjustForTZ(v_psm.open_time,'|| ''''|| vfromtz|| ''''|| ','|| ''''|| ZONE|| ''''|| ') open_time,v_psm.opened_by, v_psm.pfz_bu,v_psm.pfz_call_source, v_psm.pfz_division,v_psm.pfz_full_name, v_psm.pfz_sla_title,v_psm.pfz_total_time_spent,v_psm.priority_code, v_psm.problem_type,v_psm.product_type, v_psm.resolution_code,v_psm.resolution, v_psm.status,v_psm.updated_by, bipkg_utils.bifnc_AdjustForTZ(v_psm.update_time,'|| ''''|| vfromtz|| ''''|| ','|| ''''|| ZONE|| ''''|| ') update_time,v_psm.update_action,' || '''' || v_startdatedisplay || '''' || 'StartDateDisplay , ' || '''' || v_enddatedisplay || '''' || ' EndDateDisplay,';
        v_select_stmt := v_select_stmt || ' v_psm.category,v_psm.respond_to_onsite,v_psm.user_priority,v_psm.pfz_sla_schedule,v_psm.pfz_resolve_ola,v_psm.resolve_time,v_psm.respond_time,';        
        v_select_stmt := v_select_stmt || ' v_psm.PFZ_IMPACT,v_psm.PRIORITY,v_psm.PFZ_PRODUCT_SUBTYPE,v_psm.PFZ_COUNTRY_IMPACTED,';
...
-- Resolve Overall 
        ...
        Else
       v_select_stmt := v_select_stmt || ' SELECT  '||''''||'RESOLVE'|| ''''|| ' SLA_Type, v_psm.assignee_name SLA_User, NVL(v_psm.PFZ_RESOLVE_2ND_TARGET, '' '') Made_Missed,NVL(v_psm.PFZ_RESOLVE_2ND_TARGET_GROUP, '' '') SLA_Group,bipkg_utils.bifnc_AdjustForTZ(NVL(v_psm.PFZ_RESTORE_2ND_TARGET_TIME,v_psm.close_time),'|| ''''|| vfromtz|| ''''|| ','|| ''''|| ZONE|| ''''|| ') pfz_sla_time,';
              End If; 
        v_select_stmt := v_select_stmt || ' v_psm.action, v_psm.assignment,v_psm.assignee_name, operatorm1v.full_name,v_psm.brief_description,v_psm.closed_by, v_psm.closed_group,bipkg_utils.bifnc_AdjustForTZ(v_psm.close_time,'|| ''''|| vfromtz|| ''''|| ','|| ''''|| ZONE|| ''''|| ') close_time, v_psm.country,v_psm.flag, v_psm.last_activity,v_psm.LOCATION, v_psm.numberprgn,v_psm.open_group, bipkg_utils.bifnc_AdjustForTZ(v_psm.open_time,'|| ''''|| vfromtz|| ''''|| ','|| ''''|| ZONE|| ''''|| ') open_time,v_psm.opened_by, v_psm.pfz_bu,v_psm.pfz_call_source, v_psm.pfz_division,v_psm.pfz_full_name, v_psm.pfz_sla_title,v_psm.pfz_total_time_spent,v_psm.priority_code, v_psm.problem_type,v_psm.product_type, v_psm.resolution_code,v_psm.resolution, v_psm.status,v_psm.updated_by, bipkg_utils.bifnc_AdjustForTZ(v_psm.update_time,'|| ''''|| vfromtz|| ''''|| ','|| ''''|| ZONE|| ''''|| ') update_time,v_psm.update_action,' || '''' || v_startdatedisplay || '''' || 'StartDateDisplay , ' || '''' || v_enddatedisplay || '''' || ' EndDateDisplay,';
        v_select_stmt := v_select_stmt || ' v_psm.category,v_psm.respond_to_onsite,v_psm.user_priority,v_psm.pfz_sla_schedule,v_psm.pfz_resolve_ola,v_psm.resolve_time,v_psm.respond_time,';        
        v_select_stmt := v_select_stmt || ' v_psm.PFZ_IMPACT,v_psm.PRIORITY,v_psm.PFZ_PRODUCT_SUBTYPE,v_psm.PFZ_COUNTRY_IMPACTED,';
        v_select_stmt := v_select_stmt || ' v_psm.PFZ_RESPOND_2ND_TARGET,v_psm.PFZ_RESPOND_2ND_TARGET_GROUP,v_psm.PFZ_HP_SLA_SCHEDULE,v_psm.PFZ_HP_SLA,v_psm.PFZ_RESPOND_2ND_TARGET_USER,bipkg_utils.bifnc_AdjustForTZ(v_psm.PFZ_RESPOND_2ND_TARGET_TIME,'|| ''''|| vfromtz|| ''''|| ','|| ''''|| ZONE|| ''''|| ') pfz_respond_2nd_target_time,v_psm.PFZ_RESTORE_2ND_TARGET_USER,bipkg_utils.bifnc_AdjustForTZ(v_psm.PFZ_RESTORE_2ND_TARGET_TIME,'|| ''''|| vfromtz|| ''''|| ','|| ''''|| ZONE|| ''''|| ') pfz_restore_2nd_target_time';
        v_select_stmt := v_select_stmt || ' FROM sc.v_probsummary v_psm INNER JOIN sc.operatorm1v ON v_psm.assignee_name = operatorm1v.name WHERE (';
              IF vtarget_metric = 'Primary'
           Then
...
-- Restore Overall 
        ...
        v_select_stmt := v_select_stmt || ' SELECT  '||''''||'RESTORE'|| ''''|| ' SLA_Type, v_psm.pfz_restore_sla_user SLA_User, v_psm.pfz_restore_sla Made_Missed,v_psm.pfz_restore_sla_group SLA_Group,NVL(bipkg_utils.bifnc_AdjustForTZ(v_psm.pfz_restore_sla_time,'|| ''''|| vfromtz|| ''''|| ','|| ''''|| ZONE|| ''''|| '),v_psm.close_time) pfz_sla_time,';
        Else
        v_select_stmt := v_select_stmt || ' SELECT  '||''''||'RESTORE'|| ''''|| ' SLA_Type, v_psm.pfz_restore_sla_user SLA_User, NVL(v_psm.PFZ_RESTORE_2ND_TARGET, '' '') Made_Missed,NVL(v_psm.PFZ_RESTORE_2ND_TARGET_GROUP, '' '') SLA_Group,NVL(bipkg_utils.bifnc_AdjustForTZ(v_psm.pfz_restore_sla_time,'|| ''''|| vfromtz|| ''''|| ','|| ''''|| ZONE|| ''''|| '),v_psm.close_time) pfz_sla_time,';
        End If; 
        v_select_stmt := v_select_stmt || ' v_psm.action, v_psm.assignment,v_psm.assignee_name, operatorm1v.full_name,v_psm.brief_description,v_psm.closed_by, v_psm.closed_group,bipkg_utils.bifnc_AdjustForTZ(v_psm.close_time,'|| ''''|| vfromtz|| ''''|| ','|| ''''|| ZONE|| ''''|| ') close_time, v_psm.country,v_psm.flag, v_psm.last_activity,v_psm.LOCATION, v_psm.numberprgn,v_psm.open_group, bipkg_utils.bifnc_AdjustForTZ(v_psm.open_time,'|| ''''|| vfromtz|| ''''|| ','|| ''''|| ZONE|| ''''|| ') open_time,v_psm.opened_by, v_psm.pfz_bu,v_psm.pfz_call_source, v_psm.pfz_division,v_psm.pfz_full_name, v_psm.pfz_sla_title,v_psm.pfz_total_time_spent,v_psm.priority_code, v_psm.problem_type,v_psm.product_type, v_psm.resolution_code,v_psm.resolution, v_psm.status,v_psm.updated_by, bipkg_utils.bifnc_AdjustForTZ(v_psm.update_time,'|| ''''|| vfromtz|| ''''|| ','|| ''''|| ZONE|| ''''|| ') update_time,v_psm.update_action,' || '''' || v_startdatedisplay || '''' || 'StartDateDisplay , ' || '''' || v_enddatedisplay || '''' || ' EndDateDisplay,';
        v_select_stmt := v_select_stmt || ' v_psm.category,v_psm.respond_to_onsite,v_psm.user_priority,v_psm.pfz_sla_schedule,v_psm.pfz_resolve_ola,v_psm.resolve_time,v_psm.respond_time,';        
        v_select_stmt := v_select_stmt || ' v_psm.PFZ_IMPACT,v_psm.PRIORITY,v_psm.PFZ_PRODUCT_SUBTYPE,v_psm.PFZ_COUNTRY_IMPACTED,';
...
-- Resolve Overall 
        ...
        v_select_stmt := v_select_stmt || ' SELECT  '||''''||'RESOLVE'|| ''''|| ' SLA_Type, v_psm.assignee_name SLA_User, v_psm.pfz_resolve_sla Made_Missed,v_psm.assignment SLA_Group,bipkg_utils.bifnc_AdjustForTZ(v_psm.close_time,'|| ''''|| vfromtz|| ''''|| ','|| ''''|| ZONE|| ''''|| ') pfz_sla_time,';
        Else
       v_select_stmt := v_select_stmt || ' SELECT  '||''''||'RESOLVE'|| ''''|| ' SLA_Type, v_psm.assignee_name SLA_User, NVL(v_psm.PFZ_RESOLVE_2ND_TARGET, '' '') Made_Missed,NVL(v_psm.PFZ_RESOLVE_2ND_TARGET_GROUP, '' '') SLA_Group,bipkg_utils.bifnc_AdjustForTZ(v_psm.close_time,'|| ''''|| vfromtz|| ''''|| ','|| ''''|| ZONE|| ''''|| ') pfz_sla_time,';
              End If; 
        v_select_stmt := v_select_stmt || ' v_psm.action, v_psm.assignment,v_psm.assignee_name, operatorm1v.full_name,v_psm.brief_description,v_psm.closed_by, v_psm.closed_group,bipkg_utils.bifnc_AdjustForTZ(v_psm.close_time,'|| ''''|| vfromtz|| ''''|| ','|| ''''|| ZONE|| ''''|| ') close_time, v_psm.country,v_psm.flag, v_psm.last_activity,v_psm.LOCATION, v_psm.numberprgn,v_psm.open_group, bipkg_utils.bifnc_AdjustForTZ(v_psm.open_time,'|| ''''|| vfromtz|| ''''|| ','|| ''''|| ZONE|| ''''|| ') open_time,v_psm.opened_by, v_psm.pfz_bu,v_psm.pfz_call_source, v_psm.pfz_division,v_psm.pfz_full_name, v_psm.pfz_sla_title,v_psm.pfz_total_time_spent,v_psm.priority_code, v_psm.problem_type,v_psm.product_type, v_psm.resolution_code,v_psm.resolution, v_psm.status,v_psm.updated_by, bipkg_utils.bifnc_AdjustForTZ(v_psm.update_time,'|| ''''|| vfromtz|| ''''|| ','|| ''''|| ZONE|| ''''|| ') update_time,v_psm.update_action,' || '''' || v_startdatedisplay || '''' || 'StartDateDisplay , ' || '''' || v_enddatedisplay || '''' || ' EndDateDisplay,';
        v_select_stmt := v_select_stmt || ' v_psm.category,v_psm.respond_to_onsite,v_psm.user_priority,v_psm.pfz_sla_schedule,v_psm.pfz_resolve_ola,v_psm.resolve_time,v_psm.respond_time,';        
        v_select_stmt := v_select_stmt || ' v_psm.PFZ_IMPACT,v_psm.PRIORITY,v_psm.PFZ_PRODUCT_SUBTYPE,v_psm.PFZ_COUNTRY_IMPACTED,';
...
-- Respond Analyst
        ...
        v_select_stmt := v_select_stmt || Bipkg_Utils.bifnc_createinlist ('NVL(v_psm.PFZ_RESPOND_2ND_TARGET_GROUP, '' '')', vassignmentgroup) || ')';
        End If; 
        v_select_stmt := v_select_stmt || ' AND ('|| Bipkg_Utils.bifnc_createinlist ('NVL(v_psm.assignment, '' '')', vassignmentgroup) || ')';
...
**************************************************************************/
   ...
   BEGIN
      ...
      v_gmt_enddate_str    := TO_CHAR (v_gmt_enddate, 'DD-MM-YYYY HH24:MI:SS');
        ...
        Else
        v_select_stmt := 'SELECT ''RESOLVE'' SLA_Type, v_psm.pfz_respond_sla_user, NVL(v_psm.PFZ_RESPOND_2ND_TARGET, '' ''), NVL(v_psm.PFZ_RESPOND_2ND_TARGET_GROUP, '' ''), bipkg_utils.bifnc_AdjustForTZ(pfz_respond_sla_time,''' || vfromtz || ''' , ''' || ZONE || ''') pfz_respond_sla_time,';
        End If; 
...
***********************************************************/
   ...
   BEGIN
      ...
      v_gmt_enddate_str    := TO_CHAR (v_gmt_enddate, 'DD-MM-YYYY HH24:MI:SS');
        ...
        v_select_stmt := v_select_stmt || ' v_psm.PFZ_IMPACT,v_psm.PRIORITY,v_psm.PFZ_PRODUCT_SUBTYPE,v_psm.PFZ_COUNTRY_IMPACTED,';
        v_select_stmt := v_select_stmt || ' v_psm.PFZ_RESPOND_2ND_TARGET,v_psm.PFZ_RESPOND_2ND_TARGET_GROUP,v_psm.PFZ_HP_SLA_SCHEDULE';
        v_select_stmt := v_select_stmt || ' FROM sc.v_probsummary v_psm INNER JOIN sc.operatorm1v ON v_psm.pfz_respond_sla_user = operatorm1v.name ';
        ...
        End If; 
        v_select_stmt := v_select_stmt || ' AND ('|| Bipkg_Utils.bifnc_createinlist ('v_psm.assignment', vassignmentgroup) || ')';
        v_select_stmt := v_select_stmt || ' AND ('|| Bipkg_Utils.bifnc_createinlist ('v_psm.open_group', vorig_group)  || ')';
        v_select_stmt := v_select_stmt || ' AND v_psm.close_time between to_date(''' || v_gmt_startdate_str || ''',''' || 'DD-MM-YYYY HH24:MI:SS' || ''') and to_date(''' || v_gmt_enddate_str || ''',''' || 'DD-MM-YYYY HH24:MI:SS' || ''') AND (';
        ...
        v_select_stmt := v_select_stmt || ' v_psm.PFZ_IMPACT,v_psm.PRIORITY,v_psm.PFZ_PRODUCT_SUBTYPE,v_psm.PFZ_COUNTRY_IMPACTED,';
        v_select_stmt := v_select_stmt || ' v_psm.PFZ_RESOLVE_2ND_TARGET,v_psm.PFZ_RESOLVE_2ND_TARGET_GROUP,v_psm.PFZ_HP_SLA_SCHEDULE';
        v_select_stmt := v_select_stmt || ' FROM sc.v_probsummary v_psm INNER JOIN sc.operatorm1v ON v_psm.assignee_name = operatorm1v.name ';
        v_select_stmt := v_select_stmt || ' LEFT OUTER JOIN DeviceM1 ON v_psm.LOCATION = DeviceM1.LOCATION ';
              IF vtarget_metric = 'Primary'
           Then
