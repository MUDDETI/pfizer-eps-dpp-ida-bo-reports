CREATE OR REPLACE PACKAGE BIPKG_SLA_OVERALL AS
...
/******************************************************************************
   ...
   ---------  ----------  ---------------  ------------------------------------
    3.0         06.02.08    shw         1. std. OVERALL SLA sproc:
                                            add ASSIGNMENTM1, other PARAM Tables, new Parameters
    3.1         07.16.08    shw         2. added 'Opened After' Parameter 
******************************************************************************/
   TYPE bisp_refcursor_type IS REF CURSOR;

   PROCEDURE bisp_select_sla_overall (
...
END BIPKG_SLA_OVERALL;
/
CREATE OR REPLACE PACKAGE BODY BIPKG_SLA_OVERALL
AS
/*************************************************************************************************
   NAME:       bisp_SLA_OVERALL
   PURPOSE:
   ...
   Ver        Date        Author           Description
   ---------  ----------  ---------------  ------------------------------------
    3.0         06.02.08    shw         1. std. OVERALL SLA sproc: make
                                            add ASSIGNMENTM1, other PARAM Tables, new Parameters
    3.1         07.16.08    shw         2. added 'Opened After' Parameter 
*************************************************************************************************/
